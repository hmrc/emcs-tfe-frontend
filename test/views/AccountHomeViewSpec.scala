...
class AccountHomeViewSpec extends SpecBase with FeatureSwitching {
  ...
  "The account home page" must {
    ...
    "show the banner and its content when enabled" in {
      ...
      bannerElements.getElementsByTag("p").get(0).text mustBe "EMCS will be unavailable from 5pm on Thursday 12th February 2026 to 9am on Friday 13th February 2026, due to scheduled updates."
