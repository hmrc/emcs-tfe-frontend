      ...
      s"being rendered in language code of '${messagesForLanguage.lang.code}'" when {
        ...
        s"being rendered for singular item" when {
          ...
          behave like pageWithExpectedElementsAndMessages(Seq(
            ...
            Selectors.changeItemLink(1) -> messagesForLanguage.changeEpc(testIndex1),
            Selectors.removeItemLink(1) -> messagesForLanguage.removeEpc(testIndex1),
        ...
        s"when being rendered for multiple items" when {
          ...
          behave like pageWithExpectedElementsAndMessages(Seq(
            ...
            Selectors.changeItemLink(2) -> messagesForLanguage.changeEpc(testIndex2),
            Selectors.removeItemLink(2) -> messagesForLanguage.removeEpc(testIndex2),
            Selectors.legendQuestion -> messagesForLanguage.h2,
            Selectors.radioButton(1) -> messagesForLanguage.yes,
            Selectors.radioButton(2) -> messagesForLanguage.no,
            Selectors.button -> messagesForLanguage.saveAndContinue
