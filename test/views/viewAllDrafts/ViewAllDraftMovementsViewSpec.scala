...
class ViewAllDraftMovementsViewSpec extends ViewSpecBase with ViewBehaviours with DraftMovementsFixtures {
  ...
  object Selectors extends BaseSelectors {
    val headingLinkRow = "#main-content dl dt h2 a"
    val destinationTypeRow = "#main-content dl dt > ul > li:nth-child(1)"
    val consigneeRow = "#main-content dl dt > ul > li:nth-child(2)"
    val dateOfDispatchRow = "#main-content dl dt > ul > li:nth-child(3)"
    val statusDraftRow = "#main-content dl dd > p.govuk-body > strong.govuk-tag.govuk-tag--grey"
    val statusErrorRow = "#main-content dl dd > p.govuk-body > strong.govuk-tag.govuk-tag--red"
