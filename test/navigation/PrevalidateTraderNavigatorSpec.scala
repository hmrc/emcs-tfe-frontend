    ...
    "PrevalidateConsigneeTraderIdentificationPage" must {
      ...
      "when no EPCs have been added yet" must {
        ...
        "go to PrevalidateAddExciseProductCodePage" in {
          ...
          val userAnswers = emptyUserAnswers.set(PrevalidateConsigneeTraderIdentificationPage, PrevalidateModel(ern = "AB123456", entityGroup = testEntityGroup))
      ...
      "when at least one EPC code has been added" must {
        ...
        "go to PrevalidateAddToListPage" in {
          ...
          val userAnswers = emptyUserAnswers
            .set(PrevalidateConsigneeTraderIdentificationPage, PrevalidateModel(ern = "AB123456", entityGroup = testEntityGroup))
