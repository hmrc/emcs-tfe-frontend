...
import uk.gov.hmrc.emcstfefrontend.services.GetMemberStatesService
...
trait MockGetMemberStatesService extends MockFactory {
  ...
  object MockGetMemberStatesService {
    def getMemberStates(): CallHandler1[HeaderCarrier, Future[Seq[MemberState]]] =
      (mockGetMemberStatesService.getMemberStates()(_: HeaderCarrier))
        .expects(*)
  }
}
