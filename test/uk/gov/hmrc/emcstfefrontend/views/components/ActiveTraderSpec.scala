...
import uk.gov.hmrc.emcstfefrontend.fixtures.messages.ActiveTraderMessages
...
class ActiveTraderSpec extends UnitSpec {
  ...
  "ActiveTrader" should {
    ...
    Seq(ActiveTraderMessages.English).foreach { messagesForLanguage =>
      ...
      val activeTrader = app.injector.instanceOf[uk.gov.hmrc.emcstfefrontend.views.html.components.activeTrader]
