...
class MovementPaginationHelperSpec extends SpecBase with MovementListFixtures {
  ...
  def createPageItem(index: Int): PaginationItem = PaginationItem(
    href = onPageLoad(testErn, MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, index, 10)).url,
    ...
    "1 page of movements is given" must {
      ...
      "return None" in {
        ...
        val actualResult: Option[Pagination] = Helper.constructPagination(
          pageCount = 1,
          ern = testErn,
          search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 1, 10)
        )
      ...
      "the index is 2" must {
        ...
        "return a Pagination model without a next link or ellipsis and only page items [1, 2]" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 2,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 2, 10)
          )
        ...
        "the index is 3" must {
          ...
          "return a Pagination model without a next link or ellipsis and only page items [1, 2, 3]" in {
            ...
            val actualResult: Option[Pagination] = Helper.constructPagination(
              pageCount = 3,
              ern = testErn,
              search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 3, 10)
            )
      ...
      "the index is 4" must {
        ...
        "return a Pagination model without a next link and only page items 1, an ellipsis, 3 and 4" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 4,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 4, 10)
          )
      ...
      "the index is 5" must {
        ...
        "return a Pagination model without ellipsis and page items [1, ellipsis, 4, 5, 6, ellipsis, 10]" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 10,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 5, 10)
          )
      ...
      "the index is 6" must {
        ...
        "return a Pagination model without ellipsis and page items [1, ellipsis, 5, 6, 7, ellipsis, 10]" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 10,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 6, 10)
          )
      ...
      "the index is 7" must {
        ...
        "return a Pagination model without ellipsis and page items [1, ellipsis, 6, 7, 8, ellipsis, 10]" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 10,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 7, 10)
          )
      ...
      "the index is 8" must {
        ...
        "return a Pagination model without ellipsis and page items [1, ellipsis, 7, 8, 9, 10]" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 10,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 8, 10)
          )
      ...
      "the index is 9" must {
        ...
        "return a Pagination model without ellipsis and page items [1, ellipsis, 8, 9, 10]" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 10,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 9, 10)
          )
      ...
      "the index is 10" must {
        ...
        "return a Pagination model without a next link and only page items 1, an ellipsis, 9 and 10" in {
          ...
          val actualResult: Option[Pagination] = Helper.constructPagination(
            pageCount = 10,
            ern = testErn,
            search = MovementListSearchOptions(Some(ARC), Some("ARC123456"), ArcAscending, None, None, None, None, None, None, None, None, None, 10, 10)
          )
