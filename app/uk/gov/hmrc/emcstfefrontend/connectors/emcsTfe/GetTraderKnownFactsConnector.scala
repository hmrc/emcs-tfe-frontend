...
import uk.gov.hmrc.emcstfefrontend.models.TraderKnownFacts
...
class GetTraderKnownFactsConnectorImpl @Inject()(val http: HttpClient,
                                              config: AppConfig) extends GetTraderKnownFactsHttpParser with GetTraderKnownFactsConnector with Logging {
